...
OFDM.m=64             %input('Number of OFDM symbols to be simulated m = ');
OFDM.M=26          %('Size of Alphabet M = ');
...
if a==1
    r   
semilogy(snr,r,'-ok','linewidth',1);grid;
end
if a==2
    r    
semilogy(snr,r,'-or','linewidth',1);grid;
end
if a==3
    r    
semilogy(snr,r,'-ob','linewidth',1);grid;
end
if a==4
    r
semilogy(snr,r,'-og','linewidth',1);grid;
end
if a==5
    r   
semilogy(snr,r,'-oc','linewidth',1);grid;
end
